...
/**
 * Generate private key: openssl genrsa -out private.pem 1024 openssl pkcs8
 * -topk8 -inform PEM -in private.pem -outform DER -out private.der -nocrypt
 * <p/>
 * Generate cert: openssl req -new -x509 -keyform PEM -key private.pem -outform
 * DER -out cert.der
 * 
 */
