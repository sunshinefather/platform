...
import com.platform.common.service.ServiceException;
...
public class SystemService extends BaseService {
	...
	/**
	 * 生成安全的密码，生成随机的16位salt并经过 ${HASH_INTERATIONS} 次 sha-1 hash
	 */
	...
	public static boolean validatePassword(String plainPassword, String password) {
		String plain = Encodes.unescapeHtml(plainPassword);
		byte[] salt = Encodes.decodeHex(password.substring(0,2 * SALT_SIZE));
		byte[] hashPassword = Digests.sha1(plain.getBytes(), salt, HASH_INTERATIONS);
     ...
     * 打印系统启动信息
     */
	public static boolean printSysStartInfo(){
		StringBuilder sb = new StringBuilder();
		sb.append("\r\n==========欢迎使用 "+Global.getConfig("productName")+" "+Global.getConfig("version")+"==========\r\n");
